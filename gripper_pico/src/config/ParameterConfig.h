...
constexpr uint32_t AXIS_ACCELERATION_SPS2 = 30000;//100000;
...
constexpr int32_t GRIPPER_CLOSE_STEPS = 190000;                   // Steps to fully close the gripper. 
constexpr int32_t GRIPPER_OPEN_STEPS = 190000;                    // Steps to fully open the gripper.
}
