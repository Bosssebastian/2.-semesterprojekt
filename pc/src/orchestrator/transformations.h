...
public:
    ...
    std::vector<double> getMovementVec(std::vector<std::vector<double>>, double toolAngleRot = -0.39269908169872415480783042290994, bool testWithoutCam = false); // Get vector accepted by ur_rtde moveL function
    ~Transformations(){};
private:
