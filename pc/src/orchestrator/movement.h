...
public:
    ...
    void move(std::vector<std::vector<double>>, double rotZ = -0.39269908169872415480783042290994, double speed = 0.5, double acc = 0.2, double customZ = 0.0, bool isWorldFrame = false); // world frame used for testing without cam
...
private:
    ...
    std::vector<double> stockStorage = {57.90, -110.39, 120.28, -99.85, -90, 43.97};
