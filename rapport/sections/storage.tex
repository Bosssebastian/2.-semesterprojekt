...
The purpose of the storage system is to rotate a disk with 8 storage positions, corresponding to 8 storage slots, to a requested location, so that objects can be delivered to or retrieved by the UR robot arm.
...
The best result was achieved when both implementations were used together, decreasing irregularity rate from 99\% to 13\% and generated more consistent result, decreasing standard deviation of irregularity rate from 25\% to 5\% , see table \ref{tab:encoder-software-performance}
