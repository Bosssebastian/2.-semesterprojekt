...
The robot control system was able to use coordinate transformations and angle-axis orientation to facilitate movement of the UR5 robot between requested positions. Although some limitations were encountered, especially when testing certain functions on the Raspberry Pi, the movement system was successfully integrated into the larger system.
