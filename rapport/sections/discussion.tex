...
The 2 hour test completed a total of 81 cycles (see Appendix~\ref{app:2HourResults} Table \ref{tab:2hour-test-results}) with a total of 31 errors, where each cycle consists of the robot putting a cube into storage, and returning a cube from a randomly chosen slot to the input area (see Whole system test in Appendix~\ref{videos}). Thus an average cycle time of $~1.48min$, with an error detected every $~2.61$ cycles on average.
% Total errors
