...
ADS7830::ADS7830(i2c_inst_t* i2cPort, uint sdaPin, uint sclPin, uint32_t baudrate, uint8_t i2cAddress, uint8_t samples)
    : _i2cPort(i2cPort), _sdaPin(sdaPin), _sclPin(sclPin), _baudrate(baudrate), _i2cAddress(i2cAddress), _samples(samples)
{
    
}

void ADS7830::init() {
    i2c_init(_i2cPort, _baudrate);
